...
if($check_req=  mysqli_fetch_assoc($query_res)){
    ...
    <div class="container">			
        <div class="col-md-8 single-page-left">
            <div class="single-page-info">
                <img style="height:300px;width:500px;" src="<?php echo $row['pr_image']; ?>" alt=""/>
        ...
        <div class="col-md-4 blog-right">
            ...
            <?php if($user_type==2){ ?>
            <div class="blog-tags">
                <a class="btn-primary" href="property.php?action=sent_request&id=<?php echo $pro_id;?>">Sent Request</a>
